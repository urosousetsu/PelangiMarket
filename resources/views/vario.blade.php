    ...
    <body class="bg-white">
        <div class="flex flex-col md:flex-row items-center justify-center min-h-screen px-4">
            ...
            <div class="flex flex-col items-center md:w-1/2">
                <img src="{{ asset('assets/vario.png') }}" alt="Honda Vario" class="w-80 mb-4">
                <div class="text-blue-900 font-bold text-lg mb-1">GRANDE MATTE BLACK</div>
                <div class="text-xs bg-yellow-400 px-2 py-1 rounded mb-4 font-semibold">TIPE GRANDE SMART KEY</div>
                <div class="flex space-x-4 mt-2">
                    <div class="w-8 h-8 rounded-full bg-gray-700 border-2 border-gray-300"></div>
                    <div class="w-8 h-8 rounded-full bg-red-700 border-2 border-gray-300"></div>
                    <div class="w-8 h-8 rounded-full bg-white border-2 border-gray-300"></div>
                    <div class="w-8 h-8 rounded-full bg-blue-700 border-2 border-gray-300"></div>
                </div>
            </div>
            <!-- Spesifikasi -->
